...
-- 2. 아래 보기 테이블을 사용해서 월급이 1000이상 1500이하가 아닌 사원이름과 월급을 출력 하시오. 
...
-- [문항5] 각 사원들이 현재 까지 근무한 개월수를 출력 하시오.
...
select dno as "부서번호" , count(*) as "부서별사원수", trunc (avg(salary), 2) as "평균급여"
from employee
group by dno;

-- [문항8] 2번 문항의 EMPLOYEE, 아래 DEPARTMENT 테이블을 활용하여 아래 물움에 답하시오.
